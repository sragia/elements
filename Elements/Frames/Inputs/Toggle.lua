...
---@class ELToggleInput
local toggle = EL:GetModule('toggle-input')
...
local function ConfigureFrame(f, options)
    ...
    base:SetTexture(EL.const.textures.frame.inputs.toggle)
    base:SetTexCoord(1 / 256, 167 / 256, 181 / 256, 248 / 256)
    base:SetAllPoints()

    local borderDisabled = f:CreateTexture(nil, 'ARTWORK')
    borderDisabled:SetTexture(EL.const.textures.frame.inputs.toggle)
    ...
    borderEnabled:SetTexture(EL.const.textures.frame.inputs.toggle)
    ...
    thumbDisabled:SetTexture(EL.const.textures.frame.inputs.toggle)
    ...
    thumbEnabled:SetTexture(EL.const.textures.frame.inputs.toggle)
    ...
    -- KMS part
    local thumbEnabledEnableGroup = EL.utils.animation.getAnimationGroup(thumbEnabled)
    EL.utils.animation.fade(thumbEnabled, duration, 0, 1, thumbEnabledEnableGroup)
    EL.utils.animation.move(thumbEnabled, duration, moveBy, 0, thumbEnabledEnableGroup)

    local thumbEnabledDisableGroup = EL.utils.animation.getAnimationGroup(thumbEnabled)
    EL.utils.animation.fade(thumbEnabled, duration, 1, 0, thumbEnabledDisableGroup)
    EL.utils.animation.move(thumbEnabled, duration, -moveBy, 0, thumbEnabledDisableGroup)

    local thumbDisabledEnableGroup = EL.utils.animation.getAnimationGroup(thumbDisabled)
    EL.utils.animation.fade(thumbDisabled, duration, 1, 0, thumbDisabledEnableGroup)
    EL.utils.animation.move(thumbDisabled, duration, moveBy, 0, thumbDisabledEnableGroup)

    local thumbDisabledDisableGroup = EL.utils.animation.getAnimationGroup(thumbDisabled)
    EL.utils.animation.fade(thumbDisabled, duration, 0, 1, thumbDisabledDisableGroup)
    EL.utils.animation.move(thumbDisabled, duration, -moveBy, 0, thumbDisabledDisableGroup)

    local borderDisabledDisableGroup = EL.utils.animation.getAnimationGroup(borderDisabled)
    EL.utils.animation.fade(borderDisabled, duration, 0, 1, borderDisabledDisableGroup)
    local borderDisabledEnableGroup = EL.utils.animation.getAnimationGroup(borderDisabled)
    EL.utils.animation.fade(borderDisabled, duration, 1, 0, borderDisabledEnableGroup)

    local borderEnabledDisableGroup = EL.utils.animation.getAnimationGroup(borderEnabled)
    EL.utils.animation.fade(borderEnabled, duration, 1, 0, borderEnabledDisableGroup)
    local borderEnabledEnableGroup = EL.utils.animation.getAnimationGroup(borderEnabled)
    EL.utils.animation.fade(borderEnabled, duration, 0, 1, borderEnabledEnableGroup)
    ...
    secondaryText:SetFont(EL.const.fonts.DEFAULT, 8, 'OUTLINE')
